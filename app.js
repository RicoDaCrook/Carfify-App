...
const GlobalStyles = () => (
  <style>{`
    :root {
      ...
      --color-primary: #2563eb; /* Blue 600 - A vibrant blue */
      --color-primary-hover: #1d4ed8; /* Blue 700 */
      --color-secondary: #0891b2; /* Cyan 600 - For accents */
            ...
            <div className="min-h-screen p-4 md:p-8 flex justify-center items-start">
                <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg shadow-slate-200/50 w-full max-w-4xl border border-slate-200/80">
                    <header className="text-center mb-8">
                        {/* Verweist jetzt auf die transparente PNG-Datei */}
                    ...
                    {/* Ergebnisse werden hier gerendert, wenn sie verfügbar sind */}
