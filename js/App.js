...
function InteractiveDiagnosis({ initialProblem, vehicleInfo, onDiagnosisComplete }) {
    ...
    return ( 
        <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-xl mt-6 backdrop-blur-sm">
            <h2 className="text-lg font-bold text-gray-100 mb-4">Interaktive Diagnose zur Verfeinerung</h2>
                    ...
                    <div className="flex flex-wrap gap-2 justify-center">
                        {currentAnswers.map((answer, i) => ( 
                            <button 
                                ...
                                className="bg-[#1e253a] hover:bg-[#2a3246] text-white font-medium py-2 px-4 rounded-lg transition-all duration-300 border border-gray-700 hover:border-[#4cc3ee] hover:shadow-lg hover:shadow-[#4cc3ee]/20"
                            >
                                {answer}
                            </button> 
                        ))}
                        ...
                        <div className="p-6 bg-gray-900/50 border border-gray-700 rounded-xl backdrop-blur-sm">
                            ...
                            <div className="space-y-6">
                                {aiAnalysis.possibleCauses && (
                                    <div>
                                        <strong className="text-gray-300 block mb-2">Mögliche Ursachen:</strong>
